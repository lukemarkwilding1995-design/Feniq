...
Archive is an operational state, not deletion, ownership transfer, warranty determination or evidence removal. Existing Technical Cases and linked inspections remain intact. Site name/address correction was added later in `0020_site_corrections`; controlled site/customer reassignment, retained inspection-link correction, attachments, QR/export and external transfer remain staged work. SQLite is covered by automated migration and workflow tests; PostgreSQL DDL awaits live-server validation.
