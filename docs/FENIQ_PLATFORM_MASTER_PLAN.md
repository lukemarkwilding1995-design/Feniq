...
| 30 | Product Passports | Demo workflow: persistent Site/Product IDs, company catalogue, retained lifecycle notes and inspection links, plus versioned identity/site correction with immutable old/new snapshots and linked-customer safeguards | Site metadata correction, archival/link correction, verified manufacturer identity, richer lifecycle events, external sharing and production governance |
