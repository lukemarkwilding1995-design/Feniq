...
| 30 | Product Passports | Demo workflow: persistent Site/Product IDs, company catalogue, retained lifecycle notes and inspection links, versioned identity/site correction, and controlled archive/restore with immutable history and operational blocking | Site metadata and inspection-link correction, verified manufacturer identity, richer lifecycle events, external sharing and production governance |
